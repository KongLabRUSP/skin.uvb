...
# venn diagram----
g1 <- as.character(unique(DMLtest.Ctrl.UVB.W2[fdrs < 0.1 & diff < 0]$gene))
# 660
g2 <- as.character(unique(DMLtest.SFN.UVB.W2[fdrs < 0.1 & diff < 0]$gene))
# 17
g3 <- as.character(unique(DMLtest.Ctrl.UVB.W2[fdrs < 0.1 & diff > 0]$gene))
# 2,462
g4 <- as.character(unique(DMLtest.SFN.UVB.W2[fdrs < 0.1 & diff > 0]$gene))
# 50
